...
"[project]/app/self-assessment/[id]/sendAssessment.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const sendAssessment = async (answers)=>{
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post(`/`, answers);
    return data;
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$self$2d$assessment$2f5b$id$5d2f$sendAssessment$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/self-assessment/[id]/sendAssessment.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const SelfAssessment = ()=>{
    ...
    const onSubmit = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$self$2d$assessment$2f5b$id$5d2f$sendAssessment$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendAssessment"])(answers);
        } catch (error) {
...
//# sourceMappingURL=_f12aff67._.js.map