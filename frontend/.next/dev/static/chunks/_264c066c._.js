...
const fetchGoal = async (id)=>{
    // const { data } = await axiosInstance.get<FetchGoalsResponse>(`/goals${id}`);
    // return data;
    return {
        id: 1,
...
"[project]/app/goal/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Goal = ()=>{
    ...
    const { control, handleSubmit, register, formState: { errors, isSubmitting }, reset, watch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        defaultValues: {
            name: '',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Goal.useEffect": ()=>{
            const fetchData = {
                "Goal.useEffect.fetchData": async ()=>{
                    try {
                        const goal = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$goal$2f5b$id$5d2f$fetchGoal$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchGoal"])(Number(params.id));
                        if (goal) {
                            reset({
                                name: goal.name,
...
_s(Goal, "BvjMkT/Hne98I0Uv5up90kIMes8=", false, function() {
    return [
...
//# sourceMappingURL=_264c066c._.js.map